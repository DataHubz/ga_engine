...
//!
//! Target: ~20-25 µs standard (vs 44.61 µs lazy), ~5 µs precomputed
...
fn main() {
    println!("=== Clifford-LWE-256: NTT VERSION ===\n");
    ...
    println!("Target: ~20-25 µs standard (vs 44.61 µs lazy), ~5 µs precomputed");
    println!();
